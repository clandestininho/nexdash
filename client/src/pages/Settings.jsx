...
export default function Settings() {
  ...
  const [newVidDuration, setNewVidDuration] = useState('5 min');
    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-10 text-zinc-100">
      ...
      <div className="mt-4 transition-all">
        ...
        {activeTab === 'aprendizagem' && (
          <div className="space-y-6 animate-fade-in font-body pb-10">
                        ...
                        {isExpanded && (
                          <div className="border-t border-[#1f1f23] divide-y divide-zinc-900 bg-zinc-950/20">
                            {(!module.videos || module.videos.length === 0) ? (
                              <p className="p-4 text-[10px] text-zinc-650 font-medium">Nenhuma aula cadastrada neste módulo ainda.</p>
                            ) : (
                                  ...
                                  >
                                    <div className="flex items-start gap-3 flex-1 min-w-0">
                                      ...
                                      <div className="space-y-1 min-w-0">
                                        ...
                                        <span className="inline-flex items-center gap-1.5 text-[9px] text-zinc-550 font-bold bg-[#121215] border border-zinc-900 rounded px-1.5 py-0.5">
                                    ...
                                    <button 
                                      className={`px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all ${
                                        isCurrent
                                          ...
                                          : 'bg-zinc-900 text-zinc-400 group-hover:text-white group-hover:bg-zinc-800'
                                      }`}
                                    >
                ...
                {activeVideo ? (
                  <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white overflow-hidden shadow-2xl">
                    <CardHeader className="p-4 border-b border-[#1f1f23] bg-zinc-950/30">
                      <CardTitle className="text-xs font-black uppercase text-zinc-400 flex items-center gap-2">
                    ...
                    <CardContent className="p-4 space-y-4">
                      ...
                      <div className="space-y-3.5">
                        ...
                        <div className="flex items-center justify-between border-t border-zinc-900 pt-3 text-xs">
                          <span className="text-[10px] text-zinc-500 font-bold uppercase">Duração: {activeVideo.duration || 'N/A'}</span>
                          <button
                            type="button"
            ...
            {(email.includes('gleison') || email.includes('admin') || nome.toLowerCase().includes('gleison')) && (
              <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white mt-10">
                ...
                <CardContent className="p-5 space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1">
                          ...
                          <input 
                            ...
                            className="w-full bg-[#121215] border border-zinc-850 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-650 outline-none focus:border-[#e13a40]"
                          />
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea 
                            ...
                            rows="2"
                            className="w-full bg-[#121215] border border-zinc-850 rounded-lg p-3 text-xs text-white placeholder-zinc-650 outline-none focus:border-[#e13a40]"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1 col-span-2">
                          ...
                          <select
                            ...
                            className="w-full bg-[#121215] text-white text-xs rounded-lg border border-zinc-850 p-2 outline-none focus:border-[#e13a40]"
                          >
                  ...
                  <div className="pt-4 border-t border-zinc-900 space-y-4">
                    ...
                    <div className="space-y-3">
                      {learningModules.map((m, mIdx) => (
                        <div key={m.id} className="p-3.5 bg-zinc-950/40 border border-zinc-900 rounded-xl space-y-2">
