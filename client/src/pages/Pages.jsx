...
export default function Pages() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-10">
      ...
      {/* --- TAB: ESTATÍSTICAS (HIGH FIDELITY SCREENSHOT 3) --- */}
      {activeTab === 'stats' && (
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-white flex items-center gap-2 font-display">
                <BarChart2 className="h-6 w-6 text-[#e13a40]" />
                Estatísticas de Conversão
              </h1>
              <p className="text-sm text-zinc-400 mt-0.5 font-body">Monitore a performance de captação de leads e visitas públicas.</p>
            </div>

            <select className="appearance-none bg-[#0c0c0e] border border-zinc-800 rounded-lg px-4 py-1.5 text-xs text-zinc-300 font-bold outline-none cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  ...
                  <span className="text-3xl font-black text-white mt-1 block">0</span>
                  <span className="text-[9px] text-zinc-500 leading-normal block mt-1">Nos últimos 7 dias</span>
                </div>
            ...
            <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider block">Fontes Ativas</span>
                  <span className="text-3xl font-black text-white mt-1 block">0</span>
                  <span className="text-[9px] text-zinc-500 leading-normal block mt-1">Origens diferentes</span>
                </div>
            ...
            <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white">
              <CardContent className="p-4 flex items-center justify-between">
                <div>
                  <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider block">Formulários Ativos</span>
                  <span className="text-3xl font-black text-white mt-1 block">0</span>
                  <span className="text-[9px] text-zinc-500 leading-normal block mt-1">Com submissões recentes</span>
                </div>
          ...
          {/* GRAPHS GRID (SIMULATED EXACT AXES AXIS SCREENSHOT 3) */}
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            
            {/* Leads por dia chart (Simulated) */}
            <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white lg:col-span-3">
              ...
              <CardContent className="p-6 relative">
                ...
                {/* SVG Simulated Chart Axes */}
                <div className="h-40 w-full relative flex flex-col justify-between">
                  <div className="absolute inset-0 flex items-end">
                    
                    {/* Y Axis line */}
                    <div className="h-full w-px bg-zinc-850 absolute left-8 top-0" />
                    
                    {/* X Axis line */}
                    <div className="w-full h-px bg-zinc-850 absolute left-8 bottom-6" />

                    {/* Chart axis numbers simulated */}
                    <div className="absolute left-0 bottom-6 w-6 text-right font-mono text-[9px] text-zinc-650 flex flex-col justify-between h-32 select-none">
                      <span>4</span>
                      <span>3</span>
                      <span>2</span>
                      <span>1</span>
                    ...
                    <div className="absolute left-10 bottom-0 right-0 flex justify-between text-[9px] text-zinc-600 font-mono select-none px-2">
                      <span>15/05</span>
                      <span>16/05</span>
                      <span>17/05</span>
                      <span>18/05</span>
            ...
            {/* Leads por fonte table / placeholder */}
            <Card className="bg-[#0c0c0e] border-[#1f1f23] text-white lg:col-span-2">
              <CardHeader className="pb-3 border-b border-[#1f1f23]/60 bg-zinc-950/20">
                <CardTitle className="text-xs font-bold uppercase tracking-wider text-white flex items-center gap-1.5">
              ...
              <CardContent className="p-6 flex items-center justify-center min-h-[160px] text-center text-zinc-600 text-xs">
          ...
          {/* BOTTOM FULL WIDTH EMPTY STATE (Screenshot 3) */}
          <div className="border border-[#1f1f23] rounded-xl p-12 bg-[#0c0c0e] flex flex-col items-center justify-center text-center space-y-3">
            <UserPlus className="h-10 w-10 text-zinc-700 animate-pulse" />
            <h3 className="text-xs font-extrabold text-white uppercase tracking-wider">Nenhum lead capturado</h3>
            <p className="text-[10px] text-zinc-500 max-w-sm leading-relaxed">
              Configure seu Meta Pixel e compartilhe suas páginas públicas para começar a capturar e triar novos leads automaticamente.
            </p>
          </div>
